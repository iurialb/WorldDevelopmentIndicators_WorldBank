...
# Nesse sentido, a o projeto consiste na limpeza dos dados, retirar valores faltantes e tornar a base pronta para análise.
...
dataset_wdi <- read_excel("WDI World Bank.xlsx")
...
# Como primeira etapa vamos iniciar simplificando os nomes das colunas com a função 'rename'
...
# Os dois pontos foram substituídos, mas a variável ainda é texto (chr)
...
income <- read_excel("WDI Income Group.xlsx")
